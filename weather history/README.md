...
1. 下载的时候需要显示进度条，并可以打断

2. 下载的时候可以选择更多城市

3. 更容易的部署和打开使用，以及更容易关闭

4. 改进前端 UI，让城市和日期的选择更加直观。

5. 日期不能选择今天（因为今天数据还没出来）
...
9. 增加一个按钮，可以快速选择最近的7天，14天，30天，90天，180天，365天

10. bug：点击导出excel报错：werkzeug - INFO - 127.0.0.1 - - [27/Jan/2026 06:22:44] "POST /api/weather/export HTTP/1.1" 400 -

11. 如果后端退出，前段有提示

12. 考虑程序部署到服务器上或者云端，让其他人可以快速的使用