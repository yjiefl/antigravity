...
1. bug：「显示『选中数据详情』不能取消选择曲线 ✅2026-02-07 21:40 (修复了图例点击逻辑，支持单曲线显隐)
2. 修改：获取历史数据时，可以手动选择场站，下拉选择场站，保留搜索 ✅2026-02-07 21:40
3. 修改：导入的历史辐照度，可以选择匹配哪个场站 ✅2026-02-07 21:40 (自动关联所选场站维度)
4. 优化启用限电分析的UI，减少占用空间 ✅2026-02-07 21:40 (改为紧凑网格布局)

### 待测试

### 规划

新增功能：导出数据时，包含限电结果，用0，1表示 ✅2026-02-07 21:05 已完成
将偏差考核公式纳入数据分析
