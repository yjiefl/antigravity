...
1. bug：勾选「显示所有分组」后，所有分组都看不到了,包括「选择场站名称」，我是希望所有的分组都可以选择。 ✅2026-02-07 21:05 已修复
2. 导入数据后，数据「短波辐射」跟「辐照度」一样，上下限默认为0-1000 ✅2026-02-07 18:25 已完成
3. bug：点击「导出CSV」无效 ✅2026-02-07 21:05 已修复 (移除重复变量声明)
4. bug：颜色显示和图上不一致 ✅2026-02-07 21:05 已修复 (统一使用 metricKey 查找颜色)
5. 导入的历史辐照度，自动匹配场站，不需要导入「来源」、「区域」、「匹配关键字」、「方位角」、「倾角」等信息 ✅2026-02-07 21:05 已简化
6. 历史辐照度获取的场站列表，格式仅保留：场站,经度,纬度 (支持扩展格式：场站,方位角,角度,经度,纬度,区域) ✅2026-02-07 21:05
