...
64. 坐标轴设置项通过左边框 and 输入框底纹实时匹配对应系列的颜色。 这个不够明显 ✅ 2026年1月30日 23:11
...
129. 允许修改限电背景的颜色和透明度 ✅ 2026年2月7日 17:32
130. 系统名字改为「新能源发电分析系统」 ✅ 2026年2月7日 17:33
131. 固定每个类型曲线的颜色，可以自定义 ✅ 2026年2月7日 17:33
132. 修复「显示所有分组」勾选后数据消失的 bug ✅ 2026-02-07 18:25
133. 优化限电背景逻辑，使其与 UI 勾选解耦，并修正多场站分组匹配问题 ✅ 2026-02-07 18:25
134. 导出 CSV 增加「是否限电」列 (0/1) ✅ 2026-02-07 18:25
135. 改进历史辐照度获取，支持场站参数配置与导入 ✅ 2026-02-07 18:25
136. 导入数据后，数据「短波辐射」跟「辐照度」一样，上下限默认为0-1000#### UI改进 (2026-02-08 全部完成 ✅)
137. 维度筛选「全选」「清空」「反选」按钮图标化，间距优化 ✅
     2026-02-07 21:05 已修复
138. bug：颜色显示和图上不一致 ✅ 2026-02-07 21:05 已修复
139. 导入的历史辐照度，自动匹配场站，不需要导入「来源」、「区域」、「匹配关键字」等信息 ✅ 2026-02-07 21:05
140. 历史辐照度获取的场站列表，格式仅保留：场站,经度,纬度 ✅ 2026-02-07 21:05
141. 优化启用限电分析的UI，减少占用空间 ✅ 2026年2月7日 21:40
142. 新增功能：导出数据时，包含限电结果，用0，1表示 ✅ 2026-02-07 21:05
143. **BUG修复**: 修复“选中数据详情”列表无法联动图例开关的问题。 ✅ 2026年2月7日 22:27
144. 重新设计限电分析控制面板，背景色与透明度调节现已占据整行。 ✅ 2026年2月7日 22:33
145. 取消分组维度切换功能，把所有维度都展示，并可以选择 ✅ 2026年2月8日 06:21
146. bug：「选中数据详情」的全消功能失效 ✅ 2026年2月8日 06:22
147. 取消其用悬停聚焦相关选项和功能 ✅ 2026年2月8日 06:22
148. **环境优化**: 将后端端口迁移至 `3002`，前端端口迁移至 `5175`。 ✅ 2026年2月8日 09:35
149. **鲁棒性增强**: 修复后端因 `log` 目录权限问题导致的启动崩溃。 ✅ 2026年2月8日 09:35
150. **逻辑增强**: 优化了 `setAllLegends` (全选/全消) 逻辑。 ✅ 2026年2月8日 09:35
151. **历史辐照度增强**: 修复获取报错 bug；增强维度自动匹配逻辑。 ✅ 2026年2月8日 11:45
152. 修复获取历史辐照度时的报错 ✅ 2026年2月8日 11:45
153. 「配置场站库」允许修改场站名称 ✅ 2026年2月8日 13:44
154. **历史辐照度**: 对应的维度名称由「场站」修改为「场站名称」。 ✅ 2026年2月8日 14:00
155. **维度筛选逻辑优化**: 实现多维度选择时的曲线叠加显示。 ✅ 2026年2月8日 14:00
156. **限电逻辑改进**: 实现点对点限电判断逻辑并集成至图表提示框。 ✅ 2026年2月8日 14:20
157. 「点对点判定: 限电」简写为「限电」「正常」。 ✅ 2026年2月8日 14:46
158. **2026-02-08 UI/UX 重构**: 全面升级为高密度、极简主义设计。 ✅ 2026年2月8日 20:05
159. **2026-02-09**:
     **BUG修复**: 修复历史辐照度颜色调整失效问题。 ✅ 2026-02-09 11:55
     **BUG修复**: 修复数据开放显示与坐标轴隐藏不对应问题。 ✅ 2026-02-09 11:55
     **UI优化**: 将全局缩放滑动条宽度限制为80px。 ✅ 2026-02-09 12:47
     **UI优化**: 优化自动配色逻辑。 ✅ 2026-02-09 12:50
     **新功能**: 在图表提示框 (Tooltip) 中增加「限电状态」标识。 ✅ 2026-02-09 13:25
     **数据安全性**: 确保 UI 重构不破坏现有的 CSV 解析逻辑、历史快照读取、等所有已有功能。 ✅
     **极简主义 (Minimalism)**: 消除一切不必要的空间浪费，移除冗余的装饰。 ✅ 2026-02-09 13:42
     **BUG修复**: 修复提示框限换判定边界 Bug。 ✅ 2026-02-09 13:42
     **UI优化**: 修复浅色模式下侧边栏数据数值看不清的问题。 ✅ 2026-02-09 13:42
     **运维优化**: 优化 VPS 部署脚本 (`deploy_to_vps.sh`)。 ✅ 2026-02-09 13:45
     **BUG修复**: 修复 CSV 导出数据不全、指标相互覆盖的严重 Bug。 ✅ 2026-02-09 16:25
     **运维优化**: 新增 `update_vps_db.sh` 脚本。 ✅ 2026-02-09 16:30
     **光伏模式支持**: 新增“光伏”快捷选项 (07:00-19:00)。 ✅ 2026-02-09 16:48
     **场站库导出支持**: 场站库管理新增 CSV 批量导出按钮。 ✅ 2026-02-09 17:15
     **导入覆盖修复**: 修复了场站库导入时由于名称空格导致无法覆盖的问题。 ✅ 2026-02-09 18:00

1. **2026-02-10**:
     **UI 优化**: 进一步优化「限电分析」控制面板布局，解决文字重叠问题。 ✅ 2026-02-10 09:50
     **BUG修复**: 修复单日模式下图表时间显示为 `2000-01-01` 的问题。 ✅ 2026-02-10 10:30
     **时区优化**: 修复 VPS 部署环境下预测数据（历史辐照度）偏移 8 小时的问题。通过在 Dockerfile 中强制设置 `Asia/Shanghai` 时区，并在后端解析天气 API 数据时显式附加 `+08:00` 偏移量，确保前后端时间在「中国时间」上完全对齐。 (修改人: Antigravity) ✅ 2026-02-10 12:20
     **数据持久化**: 修复场站库在手动删除并重启服务后“死而复生”的问题。 ✅ 2026-02-10 11:40
     **BUG修复**: 修复并对齐光伏模式默认状态，确保系统初始化时默认勾选「光伏模式」(07:00-19:00)，提升光伏分析场景的即用性。 (修改人: Antigravity) ✅ 2026-02-10 11:40
     **工程化**: 基础版本完成，版本号更新至 v2.0.0-20260210。 ✅ 2026-02-10 12:35

2. **2026-02-11**:
     **BUG修复**: 修复历史辐照度数据前一位小时 (滞后1小时) 的问题。因 Open-Meteo 使用“前一小时均值”作为时间戳，现已在后端自动纠正为“小时开始时间”，并增加日期边界过滤，防止跨日数据异常。 (修改人: Antigravity) ✅ 2026-02-11 11:00
     **交互优化**: 将「光伏模式」(07:00-19:00) 的默认状态调整为关闭，需用户手动开启，以适应更广泛的分析场景。 (修改人: Antigravity) ✅ 2026-02-11 11:05

3. 当前版本: v2.0.0-20260210 ✅ 版本更新
